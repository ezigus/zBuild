...
main() {
    ...
    cycle_dispatch_stage() {
        ...
        # I10-B (#1089): when objective-gate passes, confirm via the artifact
        # and emit a first-class durable event for the convergence path.
        if [[ "$_cd_stage" == "objective-gate" && "$_CYCLE_DISPATCH_VERDICT_RAW" == "pass" ]]; then
