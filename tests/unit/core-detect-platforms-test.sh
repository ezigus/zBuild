#!/usr/bin/env bash
# Tests: core/detect/platforms.sh — Platform detection engine (ADR-009)
set -euo pipefail
...
print_test_header "core/detect/platforms — platform detection engine (ADR-009)"

setup_test_env "detect-platforms"
