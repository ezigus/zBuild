...
# #754: standard template now includes design between plan_impact_cycle and review_cycle.
...
# #755: 4 CQ stages now sit between build_test_cycle and review in review_cycle.
