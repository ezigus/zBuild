...
- Bump GitHub Actions to the latest stable major version. See `.github/workflows/` for current pins (today: `actions/checkout@v6`, `actions/setup-node@v5`, `actions/upload-artifact@v7`, `peter-evans/create-pull-request@v8`).
