...
assert_eq "standard template has 6 stages" "6" "$stage_count"
...
assert_eq "_TPL_STAGES[4] is test_assessment" "test_assessment" "${_TPL_STAGES[4]}"
assert_eq "_TPL_STAGES[5] is review"          "review"          "${_TPL_STAGES[5]}"
...
assert_eq "reloaded standard template still has 6 stages (#568)" "6" "$reload_count"
