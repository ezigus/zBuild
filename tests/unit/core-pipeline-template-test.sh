...
assert_eq "standard template has 7 stages" "7" "$stage_count"
...
assert_eq "_TPL_STAGES[3] is build"           "build"           "${_TPL_STAGES[3]}"
assert_eq "_TPL_STAGES[4] is test"            "test"            "${_TPL_STAGES[4]}"
assert_eq "_TPL_STAGES[5] is test_assessment" "test_assessment" "${_TPL_STAGES[5]}"
assert_eq "_TPL_STAGES[6] is review"          "review"          "${_TPL_STAGES[6]}"
...
assert_eq "reloaded standard template still has 7 stages (#746)" "7" "$reload_count"
