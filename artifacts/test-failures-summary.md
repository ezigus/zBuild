...
unit: FAIL /home/runner/work/_temp/zbuild-state/scratch/test/zbuild-test-stage.TZ5tr4/tests/unit/template-resolvability-preflight-test.sh
  ...
  [38;2;248;113;113m✗[0m [SPEC-6] shipped corpus loads and every leaf resolves (preflight accepts, corpus=3)
integration: FAIL /home/runner/work/_temp/zbuild-state/scratch/test/zbuild-test-stage.TZ5tr4/tests/integration/pipeline-preflight-missing-stage-test.sh
...
✗ Failed to load template 'broken-contract-missing-producer' — a stage resolves to no plugin (see above); aborting[0m
  ...
  [38;2;248;113;113m✗[0m enforce: pipeline.preflight.fail event emitted
  [38;2;248;113;113m✗[0m enforce: state stub written
integration: FAIL /home/runner/work/_temp/zbuild-state/scratch/test/zbuild-test-stage.TZ5tr4/tests/integration/full-pipeline-enforce-mode-test.sh
  ...
  [38;2;248;113;113m✗[0m default-mode: structured error printed on stderr
  [38;2;248;113;113m✗[0m default-mode: pipeline.preflight.fail event emitted
integration: FAIL /home/runner/work/_temp/zbuild-state/scratch/test/zbuild-test-stage.TZ5tr4/plugins/agent/build/tests/build-test.sh
  [38;2;248;113;113m✗[0m [SPEC-8] manifest provides.result_contract == 2
    [2mexpected: 2, got: [0m
  [38;2;248;113;113m✗[0m [SPEC-8] manifest provides.result_contract == 2
e2e: FAIL /home/runner/work/_temp/zbuild-state/scratch/test/zbuild-test-stage.TZ5tr4/tests/e2e/plugin-event-balance-full-run-test.sh
  ...
  [38;2;248;113;113m✗[0m [SPEC-1] the run dispatched at least one plugin
  [38;2;248;113;113m✗[0m [SPEC-5] plugins report domain results as plugin.result
e2e: FAIL /home/runner/work/_temp/zbuild-state/scratch/test/zbuild-test-stage.TZ5tr4/tests/e2e/parity-local-vs-ci-test.sh
