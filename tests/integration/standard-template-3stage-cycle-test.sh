...
assert_eq "T1: _TPL_STAGES[7]=acceptance-gate" "acceptance-gate" "${_TPL_STAGES[7]:-}"
assert_eq "T1: _TPL_STAGES[8]=cq-preflight" "cq-preflight" "${_TPL_STAGES[8]:-}"
assert_eq "T1: _TPL_STAGES[9]=cq-audit-plan" "cq-audit-plan" "${_TPL_STAGES[9]:-}"
